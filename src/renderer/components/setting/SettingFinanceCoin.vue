  ...
  <div class="col s4" >
    ...
    <div class="card grey lighten-3" style="height: 200px; border: solid 3px #00B9E3;">
      <div class="card-content black-text">
        <span class="card-title">Монеты:</span>
...
export default Vue.extend({
  ...
  methods: {
    ...mapGetters({
      getFinanceEnableCoins: 'getFinanceEnableCoins',
      getFinanceFullCoins: 'getFinanceFullCoins'
    })
  },
  watch: {
    current(billIds) {
  ...
  created() {
    const defaultBiils = this.getFinanceEnableCoins()
    this.bills = this.getFinanceFullCoins()
